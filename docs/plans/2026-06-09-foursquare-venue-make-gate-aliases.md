---
title: Foursquare Venue Make Gate Aliases
date: 2026-06-09
status: completed
execution: code
---
...
the first gate command fails before reaching the docs-only baseline.

## Goals

- Provide stable Makefile targets for lint, test, build, and check.
- Keep the targets usable before app source or an Xcode project exists.
